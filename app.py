...
async def mcp_server_card():
    ...
    return JSONResponse(content={
        ...
        "version": "3.3.0",
        "tools": [
            {"name": "receipts.upload", "description": "Upload receipt image/PDF"},
            {"name": "receipts.process", "description": "Extract structured data with AI vision"},
            {"name": "receipts.upload_and_process", "description": "Upload + process in one call"},
            {"name": "receipts.get_markdown", "description": "Get processed receipt as Markdown"},
            {"name": "receipts.list", "description": "List receipts with filters"},
            {"name": "accounting.suggest_gl_account", "description": "AI-suggest GL account code"},
            {"name": "credits.check_balance", "description": "Check credits and plan"},
        ],
